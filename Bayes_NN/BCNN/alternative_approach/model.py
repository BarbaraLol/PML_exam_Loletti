...
class BayesianChickCallDetector(nn.Module):
    def __init__(self, in_features, out_features):
        ...
        self.fcbayesian1 = BayesianLinear(self._to_linear, 256, prior_sigma_1=prior_sigma_1, prior_sigma_2=prior_sigma_2, prior_pi=prior_pi)
        self.fcbayesian2 = BayesianLinear(256, out_features, prior_sigma_1=prior_sigma_1, prior_sigma_2=prior_sigma_2, prior_pi=prior_pi)
    ...
    def forward(self, x, sample=True):
        ...
        x = F.relu(self.ln1(self.fcbayesian1(x)))
        x = self.dropout2(x)
