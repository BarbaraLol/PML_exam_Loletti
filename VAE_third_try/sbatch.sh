...
python3 train2.py --data_dir ../Chicks_Automatic_Detection_dataset/Processed_Data_10sec/audio_segments --epochs 200  --batch_size 16 --output_dir ./results --resume ./latest_checkpoint.pth
